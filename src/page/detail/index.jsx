...
const Index = () => {
    ...
    const tabs = ['Tafsilotlar', 'Yetkazish', "To'lov", 'FAQ'];
    return (
        <div className='my-20 px-5 lg:px-32'>
            <h1 style={{ fontFamily: "Oswald", fontSize: "22px" }} className='sm:hidden'>Product nomi</h1>
            <div className='grid sm:grid-cols-2 gap-5 md:gap-10 lg:max-w-5xl'>
                <div className='border-b-blue-300 border-b-2'>
                    <div className='bg-green-500 w-full h-[250px] xl:w-[500px] xl:h-[350px] my-5 relative'>
                ...
                <div className='my-5'>
                    ...
                    <div className="grid grid-cols-4 gap-2">
                        {['36', '36.5', '37', '37.5', '38', '38.5', '39', '39.5', '40', '40.5', '41', '41.5', '42', '42.5', '43', '43.5', '44,5'].map(size => (
                            <button
                                key={size}
            ...
            <div className='max-w-sm'>
                <div className='border my-5 px-2 pt-2'>
                ...
                <div className='space-y-2'>
                    <div style={{ fontFamily: 'OswaldLight' }} className='sm:flex items-center justify-between'>
